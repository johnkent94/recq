...
<?php
	...
	$to = "recruitment@trybekent.xyz";/* YOUR EMAIL HERE */
	$subject = "Job application from Trybekent";
	$headers = "From: Job application from Trybekent <recruitment@trybekent.xyz>";
	...
	while (file_exists( 'upload_files/'.$FinalFilename )) // The folder where the files will be stored; set the permission folder to  0755. 
		...
		if($file_size > 153600){
			$errors[]='File size must be max 250Kb';
		}
		...
		$userheaders = "From: Job application from Trybekent <ecruitment@trybekent.xyz>";
...
<div id="success">
    <div class="icon icon--order-success svg">
         <svg xmlns="https://www.w3.org/TR/SVG2/" width="72px" height="72px">
